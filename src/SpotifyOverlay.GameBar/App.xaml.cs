...
namespace SpotifyOverlay.GameBar
{
    ...
    {
        private XboxGameBarWidget SpotifyOverlayWidget = null;
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            if (widgetArgs != null)
            {
                ...
                if (widgetArgs.IsLaunchActivation)
                {
                    ...
                    SpotifyOverlayWidget = new XboxGameBarWidget(
                        widgetArgs,
                        Window.Current.CoreWindow,
                        rootFrame);
                    rootFrame.Navigate(typeof(SpotifyOverlayWidget));

                    Window.Current.Closed += SpotifyOverlayWidgetWindow_Closed;
        ...
        private void SpotifyOverlayWidgetWindow_Closed(object sender, Windows.UI.Core.CoreWindowEventArgs e)
        {
            SpotifyOverlayWidget = null;
            Window.Current.Closed -= SpotifyOverlayWidgetWindow_Closed;
        }
